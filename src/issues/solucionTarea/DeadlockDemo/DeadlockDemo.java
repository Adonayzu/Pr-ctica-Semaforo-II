package issues.solucionTarea.DeadlockDemo;
...
class SemBinario {
    private int valor; // almacena el valor de semaforo y tienes dos valores 0 y 1
    ...
    //metodo esperar nos ayuda a que llame a un hilo que quiere entrar en el semaforo
    // el syncronizes nos asegura a que solo un hilo se ejecute a la vez
    ...
    // metodo notificar -----> llama a un hilo ya a terminado de usar el recurso de la memoria compartida y lo libera
    public synchronized void notificar() {
        valor++; // incrementa el valor para indicar que el recurso ya esta disponible
        notify(); //avisa al hilo que esta esperando en el metodo de esperar
    }
}
package issues.Solution.DeadolockDemo;
...
public class DeadlockDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        SemaforoBinario semaforoBinario = new SemaforoBinario();// Se agrego la instancia de semaforo
...
class SyncThread implements Runnable {
    ...
    public SyncThread(Object ob1, Object ob2, SemaforoBinario semaforoBinario) { // Se agrego el parametro de SemaforoBinario
        this.ob1 = ob1;
        this.ob2 = ob2;
        this.semaforoBinario = semaforoBinario; // Asignar el semaforo binario que esta cocmo privado con el parametro de semaforoBinario
    }
